...
# Project metadata
PROJECT_NAME = "Flight Price Prediction using Amazon SageMaker"
VERSION = "0.0.1"
DESCRIPTION = "Predicting flight tikcet prices"
...
# String to be removed from requirements if present
HYPHEN_E_DOT = "-e ."
